...
import { 
  Loader2, ShieldCheck, User, ScrollText, Phone, KeyRound, Home 
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      <main className="relative z-10 flex flex-col justify-center items-center px-6 py-20 min-h-screen">
        <Link 
          href={`/${language}`} 
          className="absolute top-6 left-6 p-2 rounded-xl bg-white shadow-modal border border-border text-earth hover:text-gold transition-colors"
        >
          <Home size={20} />
        </Link>
