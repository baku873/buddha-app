        ...
        <div className="min-h-[100svh] bg-cream flex flex-col items-center justify-center p-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
            <div className="mb-6 text-center">
              <h2 className="text-[24px] font-black text-ink mb-2">
            ...
            <button
              ...
              className="mt-6 w-full py-4 rounded-[1.8rem] bg-white border-2 border-stone/40 font-black text-[15px] text-ink"
            >
      ...
      >
        <div className="flex items-center gap-4 flex-1 min-w-0">
          ...
          <div className="min-w-0">
             <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gold mb-0.5 opacity-80">{t({ mn: "Цаг захиалах", en: "New Booking" })}</p>
             <h1 className="text-[17px] font-black text-ink truncate leading-none">
                {monkName}
             </h1>
          </div>
        </div>
        ...
        {allServices.length > 0 && (
          <div className="pt-8 pb-2">
            <div className="px-5 mb-4 flex items-center justify-between">
               <h2 className="text-[13px] font-black text-ink uppercase tracking-wider">
                  ...
                  >
                    ...
                    <div className="p-4">
                      <div className="flex items-center justify-between mb-2">
                        <p className={`text-[12px] font-black uppercase tracking-wider ${isSelected ? 'text-gold' : 'text-earth/40'}`}>
                          {svc.duration || "30 min"}
                        </p>
                        {isSelected && (
                      ...
                      <h3 className="text-[14px] font-black text-ink leading-tight mb-2 line-clamp-2 min-h-[2.5rem]">{svcName}</h3>
                      <div className="flex items-baseline gap-1">
                        <span className="text-[18px] font-black text-ink">₮{Number(svc.price).toLocaleString()}</span>
                      </div>
                    </div>
                  </motion.button>
                );
